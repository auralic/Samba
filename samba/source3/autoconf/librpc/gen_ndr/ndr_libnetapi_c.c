...
struct dcerpc_NetWkstaGetInfo_r_state {
	TALLOC_CTX *out_mem_ctx;
};

static void dcerpc_NetWkstaGetInfo_r_done(struct tevent_req *subreq);
...
{
	struct tevent_req *req;
	struct dcerpc_NetWkstaGetInfo_r_state *state;
	struct tevent_req *subreq;
	...
	subreq = dcerpc_binding_handle_call_send(state, ev, h,
			NULL, &ndr_table_libnetapi,
			NDR_NETWKSTAGETINFO, state->out_mem_ctx, r);
	if (tevent_req_nomem(subreq, req)) {
		return tevent_req_post(req, ev);
	}
	tevent_req_set_callback(subreq, dcerpc_NetWkstaGetInfo_r_done, req);
...
NTSTATUS dcerpc_NetWkstaGetInfo_r(struct dcerpc_binding_handle *h, TALLOC_CTX *mem_ctx, struct NetWkstaGetInfo *r)
{
	...
	status = dcerpc_binding_handle_call(h,
			NULL, &ndr_table_libnetapi,
			NDR_NETWKSTAGETINFO, mem_ctx, r);

	return status;
}

struct dcerpc_NetWkstaGetInfo_state {
	struct NetWkstaGetInfo orig;
	struct NetWkstaGetInfo tmp;
	TALLOC_CTX *out_mem_ctx;
};

static void dcerpc_NetWkstaGetInfo_done(struct tevent_req *subreq);
...
{
	struct tevent_req *req;
	struct dcerpc_NetWkstaGetInfo_state *state;
	struct tevent_req *subreq;
	...
	state->out_mem_ctx = talloc_named_const(state, 0,
			     "dcerpc_NetWkstaGetInfo_out_memory");
	if (tevent_req_nomem(state->out_mem_ctx, req)) {
		return tevent_req_post(req, ev);
	}
	...
	subreq = dcerpc_NetWkstaGetInfo_r_send(state, ev, h, &state->tmp);
	if (tevent_req_nomem(subreq, req)) {
		return tevent_req_post(req, ev);
	}
	tevent_req_set_callback(subreq, dcerpc_NetWkstaGetInfo_done, req);
	return req;
}
...
static void dcerpc_NetWkstaGetInfo_done(struct tevent_req *subreq)
{
	struct tevent_req *req = tevent_req_callback_data(
		subreq, struct tevent_req);
	struct dcerpc_NetWkstaGetInfo_state *state = tevent_req_data(
		req, struct dcerpc_NetWkstaGetInfo_state);
	NTSTATUS status;
	TALLOC_CTX *mem_ctx;
	...
	status = dcerpc_NetWkstaGetInfo_r_recv(subreq, mem_ctx);
	TALLOC_FREE(subreq);
	if (tevent_req_nterror(req, status)) {
		return;
	}
				...
				enum NET_API_STATUS *result)
{
	...
	status = dcerpc_NetWkstaGetInfo_r(h, mem_ctx, &r);
	if (!NT_STATUS_IS_OK(status)) {
		return status;
	}
