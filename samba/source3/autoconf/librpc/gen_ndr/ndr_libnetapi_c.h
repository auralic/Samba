...
#include "autoconf/librpc/gen_ndr/libnetapi.h"
...
struct tevent_req *dcerpc_NetWkstaGetInfo_r_send(TALLOC_CTX *mem_ctx,
	struct tevent_context *ev,
	struct dcerpc_binding_handle *h,
	struct NetWkstaGetInfo *r);
NTSTATUS dcerpc_NetWkstaGetInfo_r_recv(struct tevent_req *req, TALLOC_CTX *mem_ctx);
NTSTATUS dcerpc_NetWkstaGetInfo_r(struct dcerpc_binding_handle *h, TALLOC_CTX *mem_ctx, struct NetWkstaGetInfo *r);
struct tevent_req *dcerpc_NetWkstaGetInfo_send(TALLOC_CTX *mem_ctx,
					       struct tevent_context *ev,
					       struct dcerpc_binding_handle *h,
					       const char * _server_name /* [in] [unique] */,
					       uint32_t _level /* [in]  */,
					       uint8_t **_buffer /* [out] [ref] */);
NTSTATUS dcerpc_NetWkstaGetInfo_recv(struct tevent_req *req,
				     TALLOC_CTX *mem_ctx,
				     enum NET_API_STATUS *result);
NTSTATUS dcerpc_NetWkstaGetInfo(struct dcerpc_binding_handle *h,
				TALLOC_CTX *mem_ctx,
				const char * _server_name /* [in] [unique] */,
				uint32_t _level /* [in]  */,
				uint8_t **_buffer /* [out] [ref] */,
