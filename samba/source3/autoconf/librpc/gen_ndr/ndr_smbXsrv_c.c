...
struct dcerpc_smbXsrv_client_global_decode_r_state {
	TALLOC_CTX *out_mem_ctx;
};

static void dcerpc_smbXsrv_client_global_decode_r_done(struct tevent_req *subreq);
...
{
	struct tevent_req *req;
	struct dcerpc_smbXsrv_client_global_decode_r_state *state;
	struct tevent_req *subreq;
	...
	subreq = dcerpc_binding_handle_call_send(state, ev, h,
			NULL, &ndr_table_smbXsrv,
			NDR_SMBXSRV_CLIENT_GLOBAL_DECODE, state, r);
	if (tevent_req_nomem(subreq, req)) {
		return tevent_req_post(req, ev);
	}
	tevent_req_set_callback(subreq, dcerpc_smbXsrv_client_global_decode_r_done, req);
...
NTSTATUS dcerpc_smbXsrv_client_global_decode_r(struct dcerpc_binding_handle *h, TALLOC_CTX *mem_ctx, struct smbXsrv_client_global_decode *r)
{
	...
	status = dcerpc_binding_handle_call(h,
			NULL, &ndr_table_smbXsrv,
			NDR_SMBXSRV_CLIENT_GLOBAL_DECODE, mem_ctx, r);

	return status;
}

struct dcerpc_smbXsrv_client_global_decode_state {
	struct smbXsrv_client_global_decode orig;
	struct smbXsrv_client_global_decode tmp;
	TALLOC_CTX *out_mem_ctx;
};

static void dcerpc_smbXsrv_client_global_decode_done(struct tevent_req *subreq);
...
{
	struct tevent_req *req;
	struct dcerpc_smbXsrv_client_global_decode_state *state;
	struct tevent_req *subreq;
	...
	subreq = dcerpc_smbXsrv_client_global_decode_r_send(state, ev, h, &state->tmp);
	if (tevent_req_nomem(subreq, req)) {
		return tevent_req_post(req, ev);
	}
	tevent_req_set_callback(subreq, dcerpc_smbXsrv_client_global_decode_done, req);
	return req;
}
...
static void dcerpc_smbXsrv_client_global_decode_done(struct tevent_req *subreq)
{
	struct tevent_req *req = tevent_req_callback_data(
		subreq, struct tevent_req);
	struct dcerpc_smbXsrv_client_global_decode_state *state = tevent_req_data(
		req, struct dcerpc_smbXsrv_client_global_decode_state);
	NTSTATUS status;
	TALLOC_CTX *mem_ctx;
	...
	status = dcerpc_smbXsrv_client_global_decode_r_recv(subreq, mem_ctx);
	TALLOC_FREE(subreq);
	if (tevent_req_nterror(req, status)) {
		return;
	}
					     ...
					     struct smbXsrv_client_globalB _blob /* [in]  */)
{
	...
	status = dcerpc_smbXsrv_client_global_decode_r(h, mem_ctx, &r);
	if (!NT_STATUS_IS_OK(status)) {
		return status;
	}
...
struct dcerpc_smbXsrv_client_decode_r_state {
	TALLOC_CTX *out_mem_ctx;
};

static void dcerpc_smbXsrv_client_decode_r_done(struct tevent_req *subreq);
...
{
	struct tevent_req *req;
	struct dcerpc_smbXsrv_client_decode_r_state *state;
	struct tevent_req *subreq;
	...
	subreq = dcerpc_binding_handle_call_send(state, ev, h,
			NULL, &ndr_table_smbXsrv,
			NDR_SMBXSRV_CLIENT_DECODE, state, r);
	if (tevent_req_nomem(subreq, req)) {
		return tevent_req_post(req, ev);
	}
	tevent_req_set_callback(subreq, dcerpc_smbXsrv_client_decode_r_done, req);
...
NTSTATUS dcerpc_smbXsrv_client_decode_r(struct dcerpc_binding_handle *h, TALLOC_CTX *mem_ctx, struct smbXsrv_client_decode *r)
{
	...
	status = dcerpc_binding_handle_call(h,
			NULL, &ndr_table_smbXsrv,
			NDR_SMBXSRV_CLIENT_DECODE, mem_ctx, r);

	return status;
}

struct dcerpc_smbXsrv_client_decode_state {
	struct smbXsrv_client_decode orig;
	struct smbXsrv_client_decode tmp;
	TALLOC_CTX *out_mem_ctx;
};

static void dcerpc_smbXsrv_client_decode_done(struct tevent_req *subreq);
...
{
	struct tevent_req *req;
	struct dcerpc_smbXsrv_client_decode_state *state;
	struct tevent_req *subreq;
	...
	subreq = dcerpc_smbXsrv_client_decode_r_send(state, ev, h, &state->tmp);
	if (tevent_req_nomem(subreq, req)) {
		return tevent_req_post(req, ev);
	}
	tevent_req_set_callback(subreq, dcerpc_smbXsrv_client_decode_done, req);
	return req;
}
...
static void dcerpc_smbXsrv_client_decode_done(struct tevent_req *subreq)
{
	struct tevent_req *req = tevent_req_callback_data(
		subreq, struct tevent_req);
	struct dcerpc_smbXsrv_client_decode_state *state = tevent_req_data(
		req, struct dcerpc_smbXsrv_client_decode_state);
	NTSTATUS status;
	TALLOC_CTX *mem_ctx;
	...
	status = dcerpc_smbXsrv_client_decode_r_recv(subreq, mem_ctx);
	TALLOC_FREE(subreq);
	if (tevent_req_nterror(req, status)) {
		return;
	}
				      ...
				      struct smbXsrv_clientB _blob /* [in]  */)
{
	...
	status = dcerpc_smbXsrv_client_decode_r(h, mem_ctx, &r);
	if (!NT_STATUS_IS_OK(status)) {
		return status;
	}
...
struct dcerpc_smbXsrv_connection_pass_decode_r_state {
	TALLOC_CTX *out_mem_ctx;
};

static void dcerpc_smbXsrv_connection_pass_decode_r_done(struct tevent_req *subreq);
...
{
	struct tevent_req *req;
	struct dcerpc_smbXsrv_connection_pass_decode_r_state *state;
	struct tevent_req *subreq;
	...
	subreq = dcerpc_binding_handle_call_send(state, ev, h,
			NULL, &ndr_table_smbXsrv,
			NDR_SMBXSRV_CONNECTION_PASS_DECODE, state, r);
	if (tevent_req_nomem(subreq, req)) {
		return tevent_req_post(req, ev);
	}
	tevent_req_set_callback(subreq, dcerpc_smbXsrv_connection_pass_decode_r_done, req);
...
NTSTATUS dcerpc_smbXsrv_connection_pass_decode_r(struct dcerpc_binding_handle *h, TALLOC_CTX *mem_ctx, struct smbXsrv_connection_pass_decode *r)
{
	...
	status = dcerpc_binding_handle_call(h,
			NULL, &ndr_table_smbXsrv,
			NDR_SMBXSRV_CONNECTION_PASS_DECODE, mem_ctx, r);

	return status;
}

struct dcerpc_smbXsrv_connection_pass_decode_state {
	struct smbXsrv_connection_pass_decode orig;
	struct smbXsrv_connection_pass_decode tmp;
	TALLOC_CTX *out_mem_ctx;
};

static void dcerpc_smbXsrv_connection_pass_decode_done(struct tevent_req *subreq);
...
{
	struct tevent_req *req;
	struct dcerpc_smbXsrv_connection_pass_decode_state *state;
	struct tevent_req *subreq;
	...
	subreq = dcerpc_smbXsrv_connection_pass_decode_r_send(state, ev, h, &state->tmp);
	if (tevent_req_nomem(subreq, req)) {
		return tevent_req_post(req, ev);
	}
	tevent_req_set_callback(subreq, dcerpc_smbXsrv_connection_pass_decode_done, req);
	return req;
}
...
static void dcerpc_smbXsrv_connection_pass_decode_done(struct tevent_req *subreq)
{
	struct tevent_req *req = tevent_req_callback_data(
		subreq, struct tevent_req);
	struct dcerpc_smbXsrv_connection_pass_decode_state *state = tevent_req_data(
		req, struct dcerpc_smbXsrv_connection_pass_decode_state);
	NTSTATUS status;
	TALLOC_CTX *mem_ctx;
	...
	status = dcerpc_smbXsrv_connection_pass_decode_r_recv(subreq, mem_ctx);
	TALLOC_FREE(subreq);
	if (tevent_req_nterror(req, status)) {
		return;
	}
					       ...
					       struct smbXsrv_connection_passB _blob /* [in]  */)
{
	...
	status = dcerpc_smbXsrv_connection_pass_decode_r(h, mem_ctx, &r);
	if (!NT_STATUS_IS_OK(status)) {
		return status;
	}
