...
struct tevent_req *dcerpc_smbXsrv_client_global_decode_r_send(TALLOC_CTX *mem_ctx,
	struct tevent_context *ev,
	struct dcerpc_binding_handle *h,
	struct smbXsrv_client_global_decode *r);
NTSTATUS dcerpc_smbXsrv_client_global_decode_r_recv(struct tevent_req *req, TALLOC_CTX *mem_ctx);
NTSTATUS dcerpc_smbXsrv_client_global_decode_r(struct dcerpc_binding_handle *h, TALLOC_CTX *mem_ctx, struct smbXsrv_client_global_decode *r);
struct tevent_req *dcerpc_smbXsrv_client_global_decode_send(TALLOC_CTX *mem_ctx,
							    struct tevent_context *ev,
							    struct dcerpc_binding_handle *h,
							    struct smbXsrv_client_globalB _blob /* [in]  */);
NTSTATUS dcerpc_smbXsrv_client_global_decode_recv(struct tevent_req *req,
						  TALLOC_CTX *mem_ctx);
NTSTATUS dcerpc_smbXsrv_client_global_decode(struct dcerpc_binding_handle *h,
					     TALLOC_CTX *mem_ctx,
					     struct smbXsrv_client_globalB _blob /* [in]  */);

struct tevent_req *dcerpc_smbXsrv_client_decode_r_send(TALLOC_CTX *mem_ctx,
	struct tevent_context *ev,
	struct dcerpc_binding_handle *h,
	struct smbXsrv_client_decode *r);
NTSTATUS dcerpc_smbXsrv_client_decode_r_recv(struct tevent_req *req, TALLOC_CTX *mem_ctx);
NTSTATUS dcerpc_smbXsrv_client_decode_r(struct dcerpc_binding_handle *h, TALLOC_CTX *mem_ctx, struct smbXsrv_client_decode *r);
struct tevent_req *dcerpc_smbXsrv_client_decode_send(TALLOC_CTX *mem_ctx,
						     struct tevent_context *ev,
						     struct dcerpc_binding_handle *h,
						     struct smbXsrv_clientB _blob /* [in]  */);
NTSTATUS dcerpc_smbXsrv_client_decode_recv(struct tevent_req *req,
					   TALLOC_CTX *mem_ctx);
NTSTATUS dcerpc_smbXsrv_client_decode(struct dcerpc_binding_handle *h,
				      TALLOC_CTX *mem_ctx,
				      struct smbXsrv_clientB _blob /* [in]  */);

struct tevent_req *dcerpc_smbXsrv_connection_pass_decode_r_send(TALLOC_CTX *mem_ctx,
	struct tevent_context *ev,
	struct dcerpc_binding_handle *h,
	struct smbXsrv_connection_pass_decode *r);
NTSTATUS dcerpc_smbXsrv_connection_pass_decode_r_recv(struct tevent_req *req, TALLOC_CTX *mem_ctx);
NTSTATUS dcerpc_smbXsrv_connection_pass_decode_r(struct dcerpc_binding_handle *h, TALLOC_CTX *mem_ctx, struct smbXsrv_connection_pass_decode *r);
struct tevent_req *dcerpc_smbXsrv_connection_pass_decode_send(TALLOC_CTX *mem_ctx,
							      struct tevent_context *ev,
							      struct dcerpc_binding_handle *h,
							      struct smbXsrv_connection_passB _blob /* [in]  */);
NTSTATUS dcerpc_smbXsrv_connection_pass_decode_recv(struct tevent_req *req,
						    TALLOC_CTX *mem_ctx);
NTSTATUS dcerpc_smbXsrv_connection_pass_decode(struct dcerpc_binding_handle *h,
					       TALLOC_CTX *mem_ctx,
					       struct smbXsrv_connection_passB _blob /* [in]  */);
