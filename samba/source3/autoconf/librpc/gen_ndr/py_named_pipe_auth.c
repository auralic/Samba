...
static PyObject *py_named_pipe_auth_req_info4_get_remote_client_name(PyObject *obj, void *closure)
{
	struct named_pipe_auth_req_info4 *object = (struct named_pipe_auth_req_info4 *)pytalloc_get_ptr(obj);
	PyObject *py_remote_client_name;
	if (object->remote_client_name == NULL) {
		py_remote_client_name = Py_None;
		Py_INCREF(py_remote_client_name);
	} else {
		if (object->remote_client_name == NULL) {
			py_remote_client_name = Py_None;
			Py_INCREF(py_remote_client_name);
		} else {
			py_remote_client_name = PyUnicode_Decode(object->remote_client_name, strlen(object->remote_client_name), "utf-8", "ignore");
		}
	}
	return py_remote_client_name;
}

static int py_named_pipe_auth_req_info4_set_remote_client_name(PyObject *py_obj, PyObject *value, void *closure)
{
	struct named_pipe_auth_req_info4 *object = (struct named_pipe_auth_req_info4 *)pytalloc_get_ptr(py_obj);
	if (value == NULL) {
		PyErr_Format(PyExc_AttributeError, "Cannot delete NDR object: struct object->remote_client_name");
		return -1;
	}
	if (value == Py_None) {
		object->remote_client_name = NULL;
	} else {
		object->remote_client_name = NULL;
		{
			const char *test_str;
			...
			object->remote_client_name = talloc_str;
		}
	}
	return 0;
}

static PyObject *py_named_pipe_auth_req_info4_get_remote_client_addr(PyObject *obj, void *closure)
{
	struct named_pipe_auth_req_info4 *object = (struct named_pipe_auth_req_info4 *)pytalloc_get_ptr(obj);
	PyObject *py_remote_client_addr;
	if (object->remote_client_addr == NULL) {
		py_remote_client_addr = Py_None;
		Py_INCREF(py_remote_client_addr);
	} else {
		if (object->remote_client_addr == NULL) {
			py_remote_client_addr = Py_None;
			Py_INCREF(py_remote_client_addr);
		} else {
			py_remote_client_addr = PyUnicode_Decode(object->remote_client_addr, strlen(object->remote_client_addr), "utf-8", "ignore");
		}
	}
	return py_remote_client_addr;
}

static int py_named_pipe_auth_req_info4_set_remote_client_addr(PyObject *py_obj, PyObject *value, void *closure)
{
	struct named_pipe_auth_req_info4 *object = (struct named_pipe_auth_req_info4 *)pytalloc_get_ptr(py_obj);
	if (value == NULL) {
		PyErr_Format(PyExc_AttributeError, "Cannot delete NDR object: struct object->remote_client_addr");
		return -1;
	}
	if (value == Py_None) {
		object->remote_client_addr = NULL;
	} else {
		object->remote_client_addr = NULL;
		{
			const char *test_str;
			...
			object->remote_client_addr = talloc_str;
		}
	}
	return 0;
}

static PyObject *py_named_pipe_auth_req_info4_get_remote_client_port(PyObject *obj, void *closure)
{
	struct named_pipe_auth_req_info4 *object = (struct named_pipe_auth_req_info4 *)pytalloc_get_ptr(obj);
	PyObject *py_remote_client_port;
	py_remote_client_port = PyInt_FromLong((uint16_t)object->remote_client_port);
	return py_remote_client_port;
}

static int py_named_pipe_auth_req_info4_set_remote_client_port(PyObject *py_obj, PyObject *value, void *closure)
{
	struct named_pipe_auth_req_info4 *object = (struct named_pipe_auth_req_info4 *)pytalloc_get_ptr(py_obj);
	if (value == NULL) {
		PyErr_Format(PyExc_AttributeError, "Cannot delete NDR object: struct object->remote_client_port");
		return -1;
	}
	{
		const unsigned long long uint_max = ndr_sizeof2uintmax(sizeof(object->remote_client_port));
		if (PyLong_Check(value)) {
			...
			object->remote_client_port = test_var;
...
static PyObject *py_named_pipe_auth_req_info4_get_local_server_name(PyObject *obj, void *closure)
{
	struct named_pipe_auth_req_info4 *object = (struct named_pipe_auth_req_info4 *)pytalloc_get_ptr(obj);
	PyObject *py_local_server_name;
	if (object->local_server_name == NULL) {
		py_local_server_name = Py_None;
		Py_INCREF(py_local_server_name);
	} else {
		if (object->local_server_name == NULL) {
			py_local_server_name = Py_None;
			Py_INCREF(py_local_server_name);
		} else {
			py_local_server_name = PyUnicode_Decode(object->local_server_name, strlen(object->local_server_name), "utf-8", "ignore");
		}
	}
	return py_local_server_name;
}

static int py_named_pipe_auth_req_info4_set_local_server_name(PyObject *py_obj, PyObject *value, void *closure)
{
	struct named_pipe_auth_req_info4 *object = (struct named_pipe_auth_req_info4 *)pytalloc_get_ptr(py_obj);
	if (value == NULL) {
		PyErr_Format(PyExc_AttributeError, "Cannot delete NDR object: struct object->local_server_name");
		return -1;
	}
	if (value == Py_None) {
		object->local_server_name = NULL;
	} else {
		object->local_server_name = NULL;
		{
			const char *test_str;
			...
			object->local_server_name = talloc_str;
		}
	}
	return 0;
}

static PyObject *py_named_pipe_auth_req_info4_get_local_server_addr(PyObject *obj, void *closure)
{
	struct named_pipe_auth_req_info4 *object = (struct named_pipe_auth_req_info4 *)pytalloc_get_ptr(obj);
	PyObject *py_local_server_addr;
	if (object->local_server_addr == NULL) {
		py_local_server_addr = Py_None;
		Py_INCREF(py_local_server_addr);
	} else {
		if (object->local_server_addr == NULL) {
			py_local_server_addr = Py_None;
			Py_INCREF(py_local_server_addr);
		} else {
			py_local_server_addr = PyUnicode_Decode(object->local_server_addr, strlen(object->local_server_addr), "utf-8", "ignore");
		}
	}
	return py_local_server_addr;
}

static int py_named_pipe_auth_req_info4_set_local_server_addr(PyObject *py_obj, PyObject *value, void *closure)
{
	struct named_pipe_auth_req_info4 *object = (struct named_pipe_auth_req_info4 *)pytalloc_get_ptr(py_obj);
	if (value == NULL) {
		PyErr_Format(PyExc_AttributeError, "Cannot delete NDR object: struct object->local_server_addr");
		return -1;
	}
	if (value == Py_None) {
		object->local_server_addr = NULL;
	} else {
		object->local_server_addr = NULL;
		{
			const char *test_str;
			...
			object->local_server_addr = talloc_str;
		}
	}
	return 0;
}

static PyObject *py_named_pipe_auth_req_info4_get_local_server_port(PyObject *obj, void *closure)
{
	struct named_pipe_auth_req_info4 *object = (struct named_pipe_auth_req_info4 *)pytalloc_get_ptr(obj);
	PyObject *py_local_server_port;
	py_local_server_port = PyInt_FromLong((uint16_t)object->local_server_port);
	return py_local_server_port;
}

static int py_named_pipe_auth_req_info4_set_local_server_port(PyObject *py_obj, PyObject *value, void *closure)
{
	struct named_pipe_auth_req_info4 *object = (struct named_pipe_auth_req_info4 *)pytalloc_get_ptr(py_obj);
	if (value == NULL) {
		PyErr_Format(PyExc_AttributeError, "Cannot delete NDR object: struct object->local_server_port");
		return -1;
	}
	{
		const unsigned long long uint_max = ndr_sizeof2uintmax(sizeof(object->local_server_port));
		if (PyLong_Check(value)) {
			unsigned long long test_var;
			test_var = PyLong_AsUnsignedLongLong(value);
			if (PyErr_Occurred() != NULL) {
			...
			object->local_server_port = test_var;
		} else if (PyInt_Check(value)) {
			long test_var;
			test_var = PyInt_AsLong(value);
			if (test_var < 0 || test_var > uint_max) {
...
static PyGetSetDef py_named_pipe_auth_req_info4_getsetters[] = {
	{
		.name = discard_const_p(char, "remote_client_name"),
		.get = py_named_pipe_auth_req_info4_get_remote_client_name,
		.set = py_named_pipe_auth_req_info4_set_remote_client_name,
		.doc = discard_const_p(char, "PIDL-generated element of base type uint8")
	},
	{
		.name = discard_const_p(char, "remote_client_addr"),
		.get = py_named_pipe_auth_req_info4_get_remote_client_addr,
		.set = py_named_pipe_auth_req_info4_set_remote_client_addr,
		.doc = discard_const_p(char, "PIDL-generated element of base type uint8")
	},
	{
		.name = discard_const_p(char, "remote_client_port"),
		.get = py_named_pipe_auth_req_info4_get_remote_client_port,
		.set = py_named_pipe_auth_req_info4_set_remote_client_port,
		.doc = discard_const_p(char, "PIDL-generated element of base type uint16")
	},
	{
		.name = discard_const_p(char, "local_server_name"),
		.get = py_named_pipe_auth_req_info4_get_local_server_name,
		.set = py_named_pipe_auth_req_info4_set_local_server_name,
		.doc = discard_const_p(char, "PIDL-generated element of base type uint8")
	},
	{
		.name = discard_const_p(char, "local_server_addr"),
		.get = py_named_pipe_auth_req_info4_get_local_server_addr,
		.set = py_named_pipe_auth_req_info4_set_local_server_addr,
		.doc = discard_const_p(char, "PIDL-generated element of base type uint8")
	},
	{
		.name = discard_const_p(char, "local_server_port"),
		.get = py_named_pipe_auth_req_info4_get_local_server_port,
		.set = py_named_pipe_auth_req_info4_set_local_server_port,
		.doc = discard_const_p(char, "PIDL-generated element of base type uint16")
	},
	{
...
static struct PyModuleDef moduledef = {
	...
	.m_name = "named_pipe_auth",
	.m_doc = "named_pipe_auth DCE/RPC",
	.m_size = -1,
	.m_methods = named_pipe_auth_methods,
};
MODULE_INIT_FUNC(named_pipe_auth)
{
	PyObject *m;
	...
	PyModule_AddObject(m, "NAMED_PIPE_AUTH_MAGIC", PyStr_FromString("NPAM"));
