...
MODULE_INIT_FUNC(nbt)
{
	...
	PyModule_AddObject(m, "NBT_MAILSLOT_NETLOGON", PyStr_FromString("\\MAILSLOT\\NET\\NETLOGON"));
	PyModule_AddObject(m, "NBT_MAILSLOT_NTLOGON", PyStr_FromString("\\MAILSLOT\\NET\\NTLOGON"));
	PyModule_AddObject(m, "NBT_MAILSLOT_GETDC", PyStr_FromString("\\MAILSLOT\\NET\\GETDC"));
	PyModule_AddObject(m, "NBT_MAILSLOT_BROWSE", PyStr_FromString("\\MAILSLOT\\BROWSE"));
