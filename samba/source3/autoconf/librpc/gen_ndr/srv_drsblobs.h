...
void _decode_replPropertyMetaData1(struct pipes_struct *p, struct decode_replPropertyMetaData1 *r);
...
void _decode_PrimaryUserPasswordBlob(struct pipes_struct *p, struct decode_PrimaryUserPasswordBlob *r);
