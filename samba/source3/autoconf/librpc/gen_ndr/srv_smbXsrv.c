...
static bool api_smbXsrv_client_global_decode(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_smbXsrv.calls[NDR_SMBXSRV_CLIENT_GLOBAL_DECODE];

	r = talloc(talloc_tos(), struct smbXsrv_client_global_decode);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(smbXsrv_client_global_decode, NDR_IN, r);
	}

	_smbXsrv_client_global_decode(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(smbXsrv_client_global_decode, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_smbXsrv_client_decode(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_smbXsrv.calls[NDR_SMBXSRV_CLIENT_DECODE];

	r = talloc(talloc_tos(), struct smbXsrv_client_decode);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(smbXsrv_client_decode, NDR_IN, r);
	}

	_smbXsrv_client_decode(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(smbXsrv_client_decode, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_smbXsrv_connection_pass_decode(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_smbXsrv.calls[NDR_SMBXSRV_CONNECTION_PASS_DECODE];

	r = talloc(talloc_tos(), struct smbXsrv_connection_pass_decode);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(smbXsrv_connection_pass_decode, NDR_IN, r);
	}

	_smbXsrv_connection_pass_decode(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(smbXsrv_connection_pass_decode, NDR_OUT | NDR_SET_VALUES, r);
	}
...
/* Tables */
static const struct api_struct api_smbXsrv_cmds[] = 
{
	{"SMBXSRV_VERSION_GLOBAL_DECODE", NDR_SMBXSRV_VERSION_GLOBAL_DECODE, api_smbXsrv_version_global_decode},
	{"SMBXSRV_CLIENT_GLOBAL_DECODE", NDR_SMBXSRV_CLIENT_GLOBAL_DECODE, api_smbXsrv_client_global_decode},
	{"SMBXSRV_CLIENT_DECODE", NDR_SMBXSRV_CLIENT_DECODE, api_smbXsrv_client_decode},
	{"SMBXSRV_CONNECTION_PASS_DECODE", NDR_SMBXSRV_CONNECTION_PASS_DECODE, api_smbXsrv_connection_pass_decode},
