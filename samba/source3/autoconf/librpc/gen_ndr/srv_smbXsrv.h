...
void _smbXsrv_client_global_decode(struct pipes_struct *p, struct smbXsrv_client_global_decode *r);
void _smbXsrv_client_decode(struct pipes_struct *p, struct smbXsrv_client_decode *r);
void _smbXsrv_connection_pass_decode(struct pipes_struct *p, struct smbXsrv_connection_pass_decode *r);
...
const struct api_struct *smbXsrv_get_pipe_fns(int *n_fns);
