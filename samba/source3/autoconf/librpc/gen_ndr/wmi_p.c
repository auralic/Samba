...
static NTSTATUS dcom_proxy_IWbemServices_init(TALLOC_CTX *ctx)
{
...
static NTSTATUS dcom_proxy_IEnumWbemClassObject_init(TALLOC_CTX *ctx)
{
...
static NTSTATUS dcom_proxy_IWbemLevel1Login_init(TALLOC_CTX *ctx)
{
...
static NTSTATUS dcom_proxy_IWbemWCOSmartEnum_init(TALLOC_CTX *ctx)
{
...
static NTSTATUS dcom_proxy_IWbemFetchSmartEnum_init(TALLOC_CTX *ctx)
{
...
static NTSTATUS dcom_proxy_IWbemCallResult_init(TALLOC_CTX *ctx)
{
...
static NTSTATUS dcom_proxy_IWbemObjectSink_init(TALLOC_CTX *ctx)
{
