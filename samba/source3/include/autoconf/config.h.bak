...
#define TALLOC_BUILD_VERSION_RELEASE 9
...
#define STRING_STATIC_MODULES " pdb_smbpasswd pdb_tdbsam pdb_wbc_sam idmap_tdb idmap_tdb2 idmap_passdb idmap_nss idmap_rid idmap_autorid idmap_hash nss_info_template auth_sam auth_unix auth_winbind auth_wbc auth_domain auth_builtin auth_script vfs_default vfs_recycle vfs_audit vfs_extd_audit vfs_full_audit vfs_netatalk vfs_fake_perms vfs_default_quota vfs_readonly vfs_cap vfs_expand_msdfs vfs_shadow_copy vfs_shadow_copy2 vfs_xattr_tdb vfs_catia vfs_streams_xattr vfs_streams_depot vfs_commit vfs_readahead vfs_aio_fork vfs_aio_pthread vfs_aio_posix vfs_preopen vfs_syncops vfs_acl_xattr vfs_acl_tdb vfs_smb_traffic_analyzer vfs_dirsort vfs_scannedonly vfs_crossrename vfs_linux_xfs_sgid vfs_time_audit vfs_media_harmony"
...
#define static_decl_auth extern NTSTATUS auth_sam_init(void); extern NTSTATUS auth_unix_init(void); extern NTSTATUS auth_winbind_init(void); extern NTSTATUS auth_wbc_init(void); extern NTSTATUS auth_domain_init(void); extern NTSTATUS auth_builtin_init(void); extern NTSTATUS auth_script_init(void);

/* Decl of Static init functions */
#define static_decl_gpext 

/* Decl of Static init functions */
#define static_decl_idmap extern NTSTATUS idmap_tdb_init(void); extern NTSTATUS idmap_tdb2_init(void); extern NTSTATUS idmap_passdb_init(void); extern NTSTATUS idmap_nss_init(void); extern NTSTATUS idmap_rid_init(void); extern NTSTATUS idmap_autorid_init(void); extern NTSTATUS idmap_hash_init(void);
...
/* Decl of Static init functions */
#define static_decl_vfs extern NTSTATUS vfs_default_init(void); extern NTSTATUS vfs_recycle_init(void); extern NTSTATUS vfs_audit_init(void); extern NTSTATUS vfs_extd_audit_init(void); extern NTSTATUS vfs_full_audit_init(void); extern NTSTATUS vfs_netatalk_init(void); extern NTSTATUS vfs_fake_perms_init(void); extern NTSTATUS vfs_default_quota_init(void); extern NTSTATUS vfs_readonly_init(void); extern NTSTATUS vfs_cap_init(void); extern NTSTATUS vfs_expand_msdfs_init(void); extern NTSTATUS vfs_shadow_copy_init(void); extern NTSTATUS vfs_shadow_copy2_init(void); extern NTSTATUS vfs_xattr_tdb_init(void); extern NTSTATUS vfs_catia_init(void); extern NTSTATUS vfs_streams_xattr_init(void); extern NTSTATUS vfs_streams_depot_init(void); extern NTSTATUS vfs_commit_init(void); extern NTSTATUS vfs_readahead_init(void); extern NTSTATUS vfs_aio_fork_init(void); extern NTSTATUS vfs_aio_pthread_init(void); extern NTSTATUS vfs_aio_posix_init(void); extern NTSTATUS vfs_preopen_init(void); extern NTSTATUS vfs_syncops_init(void); extern NTSTATUS vfs_acl_xattr_init(void); extern NTSTATUS vfs_acl_tdb_init(void); extern NTSTATUS vfs_smb_traffic_analyzer_init(void); extern NTSTATUS vfs_dirsort_init(void); extern NTSTATUS vfs_scannedonly_init(void); extern NTSTATUS vfs_crossrename_init(void); extern NTSTATUS vfs_linux_xfs_sgid_init(void); extern NTSTATUS vfs_time_audit_init(void); extern NTSTATUS vfs_media_harmony_init(void);

/* Static init functions */
#define static_init_auth {  auth_sam_init();  auth_unix_init();  auth_winbind_init();  auth_wbc_init();  auth_domain_init();  auth_builtin_init();  auth_script_init();}

/* Static init functions */
#define static_init_gpext {}

/* Static init functions */
#define static_init_idmap {  idmap_tdb_init();  idmap_tdb2_init();  idmap_passdb_init();  idmap_nss_init();  idmap_rid_init();  idmap_autorid_init();  idmap_hash_init();}
...
/* Static init functions */
#define static_init_vfs {  vfs_default_init();  vfs_recycle_init();  vfs_audit_init();  vfs_extd_audit_init();  vfs_full_audit_init();  vfs_netatalk_init();  vfs_fake_perms_init();  vfs_default_quota_init();  vfs_readonly_init();  vfs_cap_init();  vfs_expand_msdfs_init();  vfs_shadow_copy_init();  vfs_shadow_copy2_init();  vfs_xattr_tdb_init();  vfs_catia_init();  vfs_streams_xattr_init();  vfs_streams_depot_init();  vfs_commit_init();  vfs_readahead_init();  vfs_aio_fork_init();  vfs_aio_pthread_init();  vfs_aio_posix_init();  vfs_preopen_init();  vfs_syncops_init();  vfs_acl_xattr_init();  vfs_acl_tdb_init();  vfs_smb_traffic_analyzer_init();  vfs_dirsort_init();  vfs_scannedonly_init();  vfs_crossrename_init();  vfs_linux_xfs_sgid_init();  vfs_time_audit_init();  vfs_media_harmony_init();}
