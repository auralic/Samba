...
/* Generated from /home/changpeng/aa/samba-4.7.6/source4/heimdal/lib/asn1/rfc2459.asn1 */
/* Do not edit */
...
(data)->q = calloc(1, sizeof(*(data)->q));
if ((data)->q == NULL) { e = ENOMEM; goto fail; }
p += l; len -= l; ret += l;
q_oldlen = len;
...
if((from)->q) {
(to)->q = malloc(sizeof(*(to)->q));
if((to)->q == NULL) goto fail;
