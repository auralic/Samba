...
static PyObject *py_sign_request_get_packet_to_sign(PyObject *obj, void *closure)
{
	...
	py_packet_to_sign = PyBytes_FromStringAndSize((char *)(object->packet_to_sign).data, (object->packet_to_sign).length);
...
static int py_sign_request_set_packet_to_sign(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	object->packet_to_sign = data_blob_talloc(pytalloc_get_mem_ctx(py_obj), PyBytes_AS_STRING(value), PyBytes_GET_SIZE(value));
	return 0;
}
...
static PyObject *py_signed_reply_get_signed_packet(PyObject *obj, void *closure)
{
	...
	py_signed_packet = PyBytes_FromStringAndSize((char *)(object->signed_packet).data, (object->signed_packet).length);
...
static int py_signed_reply_set_signed_packet(PyObject *py_obj, PyObject *value, void *closure)
{
	...
	object->signed_packet = data_blob_talloc(pytalloc_get_mem_ctx(py_obj), PyBytes_AS_STRING(value), PyBytes_GET_SIZE(value));
	return 0;
}
...
static PyObject *py_decode_sign_requst_ndr_pack(PyObject *py_obj, int ndr_inout_flags, uint32_t ndr_push_flags)
{
	...
	if (ndr_table_ntp_signd.num_calls < 1) {
...
static struct PyModuleDef moduledef = {
	...
	.m_name = "ntp_signd",
	.m_doc = "ntp_signd DCE/RPC",
	.m_size = -1,
	.m_methods = ntp_signd_methods,
};
MODULE_INIT_FUNC(ntp_signd)
{
	PyObject *m;
	PyObject *dep_talloc;
